...
![](https://relay-1.bijitongbu.site/p/2bde959fc30925821c6c17159175e059.png)
...
![](https://relay-1.bijitongbu.site/p/b04f215c3ad777760f811a94246bfed8.png)
...
![](https://relay-1.bijitongbu.site/p/cf0d5a92ae8527ad8ef06f86a43e1769.png)

这个机制你可能就有些眼熟了，它叫做 **Ask User Questions**，信息不够的时候 AI 需要先追问，不瞎猜瞎干。

我回答完之后，它生成了一份 **Design Plan**，把页面结构、风格方向、产物格式列出来，让我确认后才动手。

![](https://relay-1.bijitongbu.site/p/b3723556a83c569aaff3100035c895d6.png)
...
![](https://relay-1.bijitongbu.site/p/2e822e44d456fdc097a77d6313f318ff.png)

这个我觉得是它比较实用的一个点。

用其他工具，风格全靠你在 prompt 里描述，AI 理解多少算多少，经常需要反复调，各种抽卡。QoderWork 做的是，让你从一堆现成的风格里挑一个起点，相当于给 AI 一个明确的设计语言锚点。

![](https://relay-1.bijitongbu.site/p/c1702224476357ef3e003f8af68f3635.png)

对于不太擅长描述视觉风格的人（比如我），这个能省不少事。

我选了 Airbnb 的暖色圆角风，然后看着它在画布上一块一块地把看板搭起来。

![](https://relay-1.bijitongbu.site/p/1d192bd56ff4257f0a5cb41579264acb.png)
...
![](https://relay-1.bijitongbu.site/p/f98e4265bac6ec6d0874cae0b6e1a14b.png)

它看到标注后，就会直接给改了。

![](https://relay-1.bijitongbu.site/p/5d4b7edd331ea4bc68d407eacc8fedcb.png)

另一种是 **Nudge** 面板，可以对颜色、间距、圆角、布局这些参数做精细调整，不用打字，拉滑块就能搞定，更友好自然的交互，也更高效。

![](https://relay-1.bijitongbu.site/p/b817b37facdf62f01f819229396d53d4.png)

画笔解决「改哪里」，Nudge 解决「调什么参数」。这两搭配着用，会比纯靠打字描述修改意图要方便许多。

![](https://relay-1.bijitongbu.site/p/4816566e8c15b3149aa76855b765a2f0.png)

产出是工程文件

做完之后的效果，大体是这样子的：

![](https://relay-1.bijitongbu.site/p/a6bc7200fd482668ad7c6d38d04d7d42.png)

热力图、模型分布饼图、趋势折线、AI 同事人格卡片、排行榜……基本都有了。

这里还有个我觉得值得单独说一下的功能：右上角的 **Handoff to Qoder** 按钮。

![](https://relay-1.bijitongbu.site/p/54d2c05d5978b99b7c05a132e61ea292.png)

点一下，整个设计就变成了一个 React + Vite 的前端工程，在 Qoder IDE 里直接打开。

![](https://relay-1.bijitongbu.site/p/a2f0a59f79ffe89e77837eab478aed32.png)
...
![](https://relay-1.bijitongbu.site/p/066235122cc1b0aa496b1476e1067b19.png)
...
![](https://relay-1.bijitongbu.site/p/f309a046b9b760f611b2df361f90d2c0.png)
...
![](https://relay-1.bijitongbu.site/p/b05d94e943cb6830ce1ed6cf49e663a0.png)
...
![](https://relay-1.bijitongbu.site/p/f5f584987d3bf98450ca24d10054e076.png)
